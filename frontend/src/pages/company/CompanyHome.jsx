...
import CompanyShareCard from "../../components/company/ShareCard";
...
const DISCOVER = [
  ...
  // },
  {
    key: "company/category", label: "Find a Service", sub: "Browse what service u need", num: "02",
  ...
  {
    key: "freelance", label: "Find a Freelancer", sub: "Hire independent talent", num: "03",
  ...
  // },
  {
    key: "companyjobs", label: "Manange Jobs", sub: "Manage job vaccancies", num: "05",
            ...
            <div className="cx-profile-card cx-r2">
              ...
              <div className="cx-card-body">
                ...
                <div className="cx-btns">
                  ...
                  <button className="cx-btn cx-btn-ghost" onClick={()=>goto("/company/layout-select")}>
