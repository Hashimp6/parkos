...
export default function ForgotPasswordPageCompany() {
      ...
      >
          ...
          <div className="flex-1 flex flex-col justify-center py-8">
            ...
            {step === STEP_EMAIL && (
              ...
              >
                ...
                <div>
                  <label className="block text-xs font-semibold text-gray-500 mb-1.5">Company Email</label>
                  <input
                    type="email"
                    value={email}
            ...
            {step === STEP_NEW_PASSWORD && (
              ...
              >
                <div>
                  ...
                  <p className="text-sm text-gray-400 mb-6">Set a strong new password for your company account.</p>
                </div>
            ...
            {step === STEP_SUCCESS && (
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-400 mt-1">Redirecting you to company login…</p>
                </div>
              </div>
            )}
          </div>
        ...
        >
          ...
          <div className="relative">
            ...
            >
              Regain access to<br />your company account<br />quickly and securely.
            </h2>
            <div className="flex items-start gap-3">
              <div className="w-0.5 h-10 bg-black rounded-full flex-shrink-0 mt-0.5" />
              <p className="text-sm text-gray-700 leading-relaxed">
                We verify your company identity before allowing any password change to keep your account protected.
              </p>
            </div>
          </div>
        </div>
